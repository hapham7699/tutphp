    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>main/dangki.php"><button class="btn btn-danger">Đăng ký</button></a>
                <a class="navbar-brand" href="<?php echo base_url()?>main/dangnhap.php"><button class="btn btn-danger">Đăng nhập</button></a>
            </div>
